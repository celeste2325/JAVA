...
public class ControladorNotebook {
	...
	// invocando el metodo agregarItems(agrega 4 DetalleOrden a la lista items de la
	// orden #01) de la clase Orden.
	...
	// invocando el metodo agregarItems(agrega 2 DetalleOrden a la lista items de la
	// orden #02) de la clase Orden.
